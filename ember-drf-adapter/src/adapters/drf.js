...
export default class DrfAdapter extends RESTAdapter {
  ...
  pathForType(typeName) {
    const dasherized = dasherize(typeName);
  ...
  */
  ...
  /** Returns true if status is the number 400. */
  isInvalid(status) {
    return status === 400;
  }
  ...
  */
  ...
  /**
   * This is used by _drfToJsonAPIValidationErrors.
   *
   ...
   * @return {String} url
   */
  _stripIDFromURL(_store, snapshot) {
